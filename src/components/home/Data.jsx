...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title w-full flex flex-col sm:flex-row justify-start items-center font-serif text-2xl md:text-4xl">
        Tewodros Abebe
        <img src={hello} alt="" className="home__hand" />
      </h1>
